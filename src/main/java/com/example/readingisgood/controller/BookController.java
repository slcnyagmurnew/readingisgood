...
public class BookController {
    ...
    ResponseEntity<String> updateBook(@PathVariable String name, @Valid @RequestBody Book book) {
        try {
            book.setName(name);
            ...
            return new ResponseEntity<>(
                    "Book does not exists!", HttpStatus.BAD_REQUEST);
            ...
            return new ResponseEntity<>(
                    String.format("Book %s has not enough stock!", book.getName()), HttpStatus.UNPROCESSABLE_ENTITY);
        }
    }
