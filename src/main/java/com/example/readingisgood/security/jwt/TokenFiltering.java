...
public class TokenFiltering extends OncePerRequestFilter {
    ...
    /**
     * Get all non-permitted requests, check authorization header if it has bearer token return token after substring
     * If there is no header or bearer token return null
     */
